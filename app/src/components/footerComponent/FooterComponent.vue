<template>
	<footer class="footer">
		<div class="footer__container">
			...
			<div class="footer__column column">
				<div id="contacts" class="column__contacts">
					<p class="column__text">Контакты</p>
					<br />
					<p class="column__text">+7 977 365 84 33</p>
					<p class="column__text">polyfit@gmail.com</p>
					<br />
					<p class="column__text">По всем вопросам обращайтесь по выше указанным контактам</p>
					<br />
					<p class="column__text">Консультация бесплатная</p>
				</div>
			</div>
			<div class="footer__column column">
				<div class="column__socials">
					<p class="column__text">Наши соц сети</p>
					<a href="" class="column__soc-link soc-link"
						><img src="./assets/instagram-logo.svg" alt="" class="soc-link__icon" />
						<p class="soc-link__text">Instagram</p></a
					>
					<a href="" class="column__soc-link soc-link"
						><img src="./assets/telegram-logo.svg" alt="" class="soc-link__icon" />
						<p class="soc-link__text">Telegram</p></a
					>
					<a href="" class="column__soc-link soc-link"
						><img src="./assets/vk-logo.svg" alt="" class="soc-link__icon" />
						<p class="soc-link__text">VK</p></a
					>
				</div>
			</div>
			<div class="footer__column column">
				<div class="column__nav">
					<router-link :to="{ name: 'PageInDevelopment' }" class="column__link column__link--btn"
						>Главная</router-link
					>
