...
class Program(models.Model):
    ...
    photo_thumbnail = models.ImageField(
        verbose_name="Миниатюра", upload_to="Programs/photo_thumbnails"
    )
    ...
    training_time = models.IntegerField(
        verbose_name="Время тренировки", validators=[MaxValueValidator(255)]
    )
    trainings_per_week = models.IntegerField(
        verbose_name="Тренировок в неделю", validators=[MaxValueValidator(7)]
    )
    exercises = models.ManyToManyField(
        verbose_name="Упражнения", to=Exercise, related_name="programs"
    )
